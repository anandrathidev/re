	...
	if mylist == ['']:
	    ...
	    for i in mylist:
	        ...
	        if suburb == '':
	            ...
	            post = category.objects.filter(state= state, suburb=suburb)
...
# 	myposts = paginator.get_page(page)
	...
	context = {'pagin':pagin, 'category1':category1,'generallist':generallist, 'bedminsearch':bedminsearch, 'bedmaxsearch':bedmaxsearch, 'priceminsearch':priceminsearch, 'pricemaxsearch':pricemaxsearch}
